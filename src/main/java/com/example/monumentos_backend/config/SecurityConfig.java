        ...
        http
                .cors(cors -> cors.configurationSource(request -> {
                    ...
                    configuration.setAllowedOrigins(
                            List.of("http://localhost:8080", "https://backend-tfg-escuchatuhistoria.onrender.com", "https://backend-tfg.fly.dev", "https://web-audiogu-a-8fbc.vercel.app", "https://web-audiogu-a-three.vercel.app"));
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/v3/api-docs/**", "/swagger-ui/**", "/swagger-ui.html",
                                "/api/v1/docs/**", "/api/v1/api-docs/**", "/api/v1/swagger-ui/**")
                                .permitAll()
